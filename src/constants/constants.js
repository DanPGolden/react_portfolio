export const projects = [
  {
    ...
    description: "TuneSpace is a guide that provides biographies, discographies, and lyrics of musicians in all genres pulling data from various databases into one convenient location. By bringing multiple data streams into one centralized hub our goal is to create a communal website where users can explore their favorite artists and discover new music. The site features dynamically updated HTML and CSS with local storage used for search results and other relevant parameters.",
      image: '/images/tunespace1.png',
      tags: ['JQuery', 'JavaScript', 'Ajax'],
    source: 'https://github.com/mjamesd/crispy-happiness',
    visit: 'https://mjamesd.github.io/crispy-happiness/',
    id: 0,
  },
  {
    title: 'Digital Anvil',
    ...
    image: '/images/digitalanvil1.png',
    tags: ['Sequelize', 'JavaScript', 'Materialize', 'Bootstrap'],
    source: 'https://github.com/DanPGolden/project2',
    visit: 'https://shrouded-woodland-50128.herokuapp.com/',
    id: 1,
  },
  {
    title: 'Note Taker',
    description: "This is an application called Note Taker that can be used to write and save notes. This application uses an Express.js back end and will save and retrieve note data from a JSON file..",
      image: '/images/notetaker1.png',
      tags: ['Express', 'JavaScript'],
    source: 'https://github.com/DanPGolden/Note_Taker',
    visit: 'https://peaceful-bastion-34725.herokuapp.com/',
    id: 2,
  },
  {
    ...
    image: '/images/workscheduler1.png',
    tags: ['JavaScript', 'JQuery'],
    source: 'https://github.com/DanPGolden/work_scheduler',
    visit: 'https://danpgolden.github.io/work_scheduler/',
    id: 3,
  },
];

export const TimeLineData = [
  { year: 1998, text: 'Began work as a microbiologist', },
  { year: 2015, text: 'Started freelance developing', },
  { year: 2018, text: 'Freelance app development', },
  { year: 2021, text: 'Entered full-flex coding program through UW', },
  { year: 2022, text: 'Graduated Univeristy of Washington Coding Bootcamp', },
];